...
if __name__ == '__main__':
    classes = ['bj_bpmh', 'bj_bpps', 'bj_wkps',
               'jyz_pl', 'sly_dmyw', 'hxq_gjtps',
               'xmbhyc','yw_gkxfw','yw_nc','gbps',
               'wcaqm','wcgz','xy','bjdsyc','ywzt_yfyc',
               'hxq_gjbs','kgg_ybh']
